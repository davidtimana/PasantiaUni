...
CREATE TABLE `Ciudad` (
  ...
  CONSTRAINT `fk_departamentoss` FOREIGN KEY (`secdepartamento`) REFERENCES `Departamento` (`idDepartamento`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=99774 DEFAULT CHARSET=latin5;
